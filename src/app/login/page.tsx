...
export default function LoginPage() {
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-[#080B12] px-4 py-8">
      <div className="w-full max-w-md rounded-xl border border-slate-700/60 bg-slate-900/70 p-6 shadow-2xl backdrop-blur-sm sm:p-8">
